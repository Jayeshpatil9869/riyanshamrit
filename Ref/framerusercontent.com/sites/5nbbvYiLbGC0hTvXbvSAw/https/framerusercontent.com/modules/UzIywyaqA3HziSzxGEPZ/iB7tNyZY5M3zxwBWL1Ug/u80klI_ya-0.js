var t, e = Object.create,
    ...
    y = class {
        ...
        constructor(t) {
            c(this, "bytes", t), c(this, "offset", 0), c(this, "view"), c(this, "decoder", new TextDecoder), this.view = p(this.bytes);
        }
    };
...
var O = class t {
    ...
    constructor(t, e, r) {
        c(this, "chunkId", t), c(this, "offset", e), c(this, "length", r);
    }
...
var tU = class e {
        ...
        constructor(t, e) {
            c(this, "fieldNames", t), c(this, "options", e), c(this, "entries", []);
        }
    },
    tS = 3,
    tk = 250,
...
var tN = class {
        ...
        constructor(t) {
            c(this, "options", t), c(this, "schema"), c(this, "fields"), c(this, "supportedLookupTypes", ["All" /* All */ , "Equals" /* Equals */ , "NotEquals" /* NotEquals */ , "LessThan" /* LessThan */ , "GreaterThan" /* GreaterThan */ , "Contains" /* Contains */ , "StartsWith" /* StartsWith */ , "EndsWith" /* EndsWith */ ]), c(this, "modelPromise"), c(this, "model"), c(this, "collation");
            let e = {},
                r = [];
    ...
    tO = class {
        ...
        constructor(t, e) {
            c(this, "id", t), c(this, "url", e), c(this, "itemsPromise"), c(this, "itemLoader", new d.default(async t => {
                let e = t.map(t => {
    ...
    tP = class {
        ...
        constructor(t) {
            c(this, "options", t), c(this, "id"), c(this, "schema"), c(this, "indexes"), c(this, "resolveRichText"), c(this, "resolveVectorSetItem"), c(this, "chunks"), this.chunks = this.options.chunks.map((t, e) => new tO(e, t)), this.schema = t.schema, this.indexes = t.indexes, this.resolveRichText = t.resolveRichText, this.resolveVectorSetItem = t.resolveVectorSetItem, this.id = t.id;
        }
    };
export {
