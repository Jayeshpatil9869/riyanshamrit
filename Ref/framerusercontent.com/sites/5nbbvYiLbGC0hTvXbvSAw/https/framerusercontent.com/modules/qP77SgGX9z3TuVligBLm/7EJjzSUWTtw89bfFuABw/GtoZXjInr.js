...
fontStore.loadFonts(["FS;Sentient-light italic", "Inter-Bold", "Inter-BoldItalic", "Inter-SemiBoldItalic"]);
export const fonts = [{
    explicitInter: true,
    fonts: [{
        family: "Sentient",
...
export const css = ['.framer-JwmOH .framer-styles-preset-rvm0eh:not(.rich-text-wrapper), .framer-JwmOH .framer-styles-preset-rvm0eh.rich-text-wrapper h6 { --framer-font-family: "Sentient", "Sentient Placeholder", serif; --framer-font-family-bold: "Inter", "Inter Placeholder", sans-serif; --framer-font-family-bold-italic: "Inter", "Inter Placeholder", sans-serif; --framer-font-family-italic: "Inter", "Inter Placeholder", sans-serif; --framer-font-open-type-features: normal; --framer-font-size: 18px; --framer-font-style: italic; --framer-font-style-bold: normal; --framer-font-style-bold-italic: italic; --framer-font-style-italic: italic; --framer-font-variation-axes: normal; --framer-font-weight: 300; --framer-font-weight-bold: 700; --framer-font-weight-bold-italic: 700; --framer-font-weight-italic: 600; --framer-letter-spacing: -0.25px; --framer-line-height: 140%; --framer-paragraph-spacing: 20px; --framer-text-alignment: start; --framer-text-color: var(--token-c5c4fdcb-9482-48bb-aedf-353188472aae, #151515); --framer-text-decoration: none; --framer-text-stroke-color: initial; --framer-text-stroke-width: initial; --framer-text-transform: none; }'];
export const className = "framer-JwmOH";
