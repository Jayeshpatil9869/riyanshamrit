...
const Component = /*#__PURE__*/ React.forwardRef(function(props, ref) {
    ...
    return /*#__PURE__*/ _jsx(SVG, { ...restProps,
        className: cx("framer-fWMLr", className),
        layoutId: layoutId,
        ref: ref,
        style: {
            "--21h8s6": ezTt3ayMo,
 ...
 */
const Icon = withCSS(Component, css, "framer-fWMLr");
export default Icon;
