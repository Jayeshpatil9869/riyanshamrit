...
export const HomePage: React.FC = () => {
  ...
  // Category Tabs for Products Grid
  const [selectedCategoryTab, setSelectedCategoryTab] = useState('all');

  const categoryTabs = [
    { id: 'all', label: 'All Products', count: 6 },
    { id: 'Cleansers', label: 'Cleansers', count: 2 },
    { id: 'Serums', label: 'Serums', count: 2 },
    { id: 'Moisturizers', label: 'Moisturizers', count: 2 },
  ];
  ...
  const filteredProducts = React.useMemo(() => {
    ...
    return RIYANSH_PRODUCTS.filter((p) => p.category === selectedCategoryTab).slice(0, 3);
  }, [selectedCategoryTab]);
  ...
  return (
    <div className="w-full relative bg-[#f2f2ef] text-[#1a1c18]">
        ...
        <div className="kanva-container relative z-10 w-full pt-16 pb-24 sm:py-28">
          <div className="max-w-xl text-white space-y-6">
            ...
            <FramerReveal delay={0.1}>
              <h1 className="font-serif text-5xl sm:text-7xl lg:text-8xl font-normal leading-[0.96] tracking-[-0.035em] text-white">
                Natural <br />
            ...
            {/* CTA Pill Button */}
            <FramerReveal delay={0.3} className="pt-2">
              <motion.button
                whileHover={{ scale: 1.03 }}
                whileTap={{ scale: 0.96 }}
                id="hero-shop-now"
                onClick={() => navigate('/store')}
                className="px-8 py-3.5 rounded-full bg-white hover:bg-[#dac5a7] text-[#1a1c18] text-xs font-sans font-medium tracking-wide transition-all shadow-xl inline-flex items-center gap-2 cursor-pointer"
              >
                <span>Shop Now</span>
              </motion.button>
            </FramerReveal>
      ...
      {/* 2. THE 4 VALUE PILLARS BAR (Floating 4-Card Grid from Reference) */}
      <section className="relative -mt-8 sm:-mt-12 z-20">
        <div className="kanva-container">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            
            {/* Pillar 1: Natural Formula */}
            <div className="p-6 bg-white rounded-2xl border border-[rgba(26,28,24,0.08)] shadow-[0_8px_24px_rgba(26,28,24,0.04)] text-center space-y-2">
              <div className="w-10 h-10 rounded-full bg-[#f5f4ef] text-[#2b3323] flex items-center justify-center mx-auto">
                <Leaf className="w-4 h-4 text-[#2b3323]" />
              </div>
              ...
              <p className="text-xs text-[#1a1c18]/65 font-body leading-relaxed">
                Made with pure organic ingredients for healthy, glowing skin.
              </p>
            </div>
            ...
            <div className="p-6 bg-white rounded-2xl border border-[rgba(26,28,24,0.08)] shadow-[0_8px_24px_rgba(26,28,24,0.04)] text-center space-y-2">
              <div className="w-10 h-10 rounded-full bg-[#f5f4ef] text-[#2b3323] flex items-center justify-center mx-auto">
                <Heart className="w-4 h-4 text-[#2b3323]" />
              </div>
              <h3 className="font-serif text-base sm:text-lg text-[#1a1c18] font-medium">
                Cruelty-Free
              </h3>
              <p className="text-xs text-[#1a1c18]/65 font-body leading-relaxed">
                All products are never tested on animals, 100% vegan certified.
              </p>
            </div>
            ...
            <div className="p-6 bg-white rounded-2xl border border-[rgba(26,28,24,0.08)] shadow-[0_8px_24px_rgba(26,28,24,0.04)] text-center space-y-2">
              <div className="w-10 h-10 rounded-full bg-[#f5f4ef] text-[#2b3323] flex items-center justify-center mx-auto">
                <ShieldCheck className="w-4 h-4 text-[#2b3323]" />
              </div>
              <h3 className="font-serif text-base sm:text-lg text-[#1a1c18] font-medium">
                Expert-Approved
              </h3>
              <p className="text-xs text-[#1a1c18]/65 font-body leading-relaxed">
                Carefully crafted and tested to ensure safety and visible results.
              </p>
            </div>
            ...
            <div className="p-6 bg-white rounded-2xl border border-[rgba(26,28,24,0.08)] shadow-[0_8px_24px_rgba(26,28,24,0.04)] text-center space-y-2">
              <div className="w-10 h-10 rounded-full bg-[#f5f4ef] text-[#2b3323] flex items-center justify-center mx-auto">
                <Truck className="w-4 h-4 text-[#2b3323]" />
              </div>
              <h3 className="font-serif text-base sm:text-lg text-[#1a1c18] font-medium">
                Free Shipping
              </h3>
              <p className="text-xs text-[#1a1c18]/65 font-body leading-relaxed">
                Enjoy free shipping on all orders over $50 with fast delivery.
              </p>
            </div>
      ...
      {/* 3. SIGNATURE EDITORIAL STATEMENT (Exact from Reference with Embedded Thumbnail Images) */}
      <section className="py-20 sm:py-28 text-center relative overflow-hidden">
        <HaikeiBackground variant="contour" opacity={0.2} />
        <div className="kanva-container relative z-10 max-w-4xl">
          <FramerReveal>
            <h2 className="font-serif text-3xl sm:text-5xl lg:text-6xl text-[#1a1c18] font-normal leading-[1.3] tracking-[-0.03em]">
              Refresh your skin,{' '}
              <img
                src="/assets/images/vAsQUc57V7vQ6L24k7FTe2aAk0g.webp"
                alt="skincare treatment"
                className="inline-block w-8 h-8 sm:w-10 sm:h-10 rounded-full align-middle mx-1 object-cover shadow-xs ring-2 ring-white"
              />{' '}
              love yourself,{' '}
              <img
                ...
                className="inline-block w-8 h-8 sm:w-10 sm:h-10 rounded-full align-middle mx-1 object-cover shadow-xs ring-2 ring-white"
              /> <br />
              <span className="italic text-[#2b3323] font-normal inline-flex items-center gap-2 justify-center flex-wrap">
                renew your glow.
                <img
                  src="/assets/images/leaf-botanical.png"
                  alt="botanical leaf"
                  className="inline-block w-10 h-10 sm:w-14 sm:h-14 object-contain align-middle -mt-1 drop-shadow-xs"
                />
              </span>
            </h2>
          </FramerReveal>
      ...
      <section className="pb-24">
        <div className="kanva-container">
          ...
          <div className="mb-12 flex justify-center overflow-x-auto pb-2 scrollbar-none">
            <AnimatedTabs
              tabs={categoryTabs}
          ...
          {/* View All Products Underlined Link */}
          <div className="mt-14 text-center">
            <button
              onClick={() => navigate('/store')}
              className="text-xs font-mono uppercase tracking-widest text-[#1a1c18] hover:text-[#2b3323] underline underline-offset-8 transition-colors cursor-pointer font-semibold"
            >
              VIEW ALL PRODUCTS
            </button>
          </div>
      ...
      {/* 5. "ECO-FRIENDLY, SKIN-FRIENDLY" GREEN BOTANICAL BANNER (Exact 1-to-1 Match with Reference) */}
      <section className="py-10 sm:py-14">
        <div className="kanva-container">
          <div className="relative w-full rounded-3xl sm:rounded-[36px] overflow-hidden bg-[#182015] min-h-[460px] sm:min-h-[500px] lg:min-h-[540px] flex items-center shadow-2xl border border-white/10">
            ...
            <div className="relative z-10 p-8 sm:p-14 lg:p-20 max-w-xl space-y-6 text-white">
              <h2 className="font-serif text-4xl sm:text-5xl lg:text-6xl text-white font-normal leading-[1.08] tracking-[-0.03em]">
                <span className="text-white block">Eco-Friendly,</span>
                <span className="italic text-white/90 block">Skin-Friendly</span>
              </h2>

              <p className="text-sm sm:text-base text-white/80 font-body leading-relaxed max-w-md">
              ...
              {/* 3 Outline Features */}
              <div className="space-y-3.5 pt-2 text-white">
                <div className="flex items-center gap-3 text-xs sm:text-sm text-white font-normal">
      ...
      <section className="py-20 sm:py-28">
        <div className="kanva-container">
          ...
          <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-10 sm:mb-12 gap-6">
            ...
            <div className="flex items-center gap-3">
              <div className="flex flex-col items-start sm:items-end">
                ...
                <span className="text-[11px] font-mono text-[#1a1c18]/60 mt-0.5">4.9 (2,400+ reviews)</span>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
            ...
            <div className="lg:col-span-6 relative rounded-[28px] sm:rounded-[32px] overflow-hidden bg-[#e8e8e1] border border-[rgba(26,28,24,0.06)] shadow-xs group min-h-[460px] lg:min-h-0 flex flex-col justify-end">
              <img
              ...
              <div className="relative z-10 m-6 max-w-[260px] p-4 sm:p-5 bg-white rounded-2xl shadow-[0_10px_30px_rgba(0,0,0,0.08)] border border-black/5">
                <div className="flex items-center gap-2 mb-1.5">
                  ...
                  <span className="font-sans font-semibold text-xs text-[#1a1c18]">Proven Effectiveness</span>
                </div>
                <p className="text-[11px] text-[#1a1c18]/65 font-body leading-relaxed">
            ...
            <div className="lg:col-span-6 flex flex-col gap-6 justify-between">
              ...
              <div className="p-7 sm:p-8 bg-[#eae6df] rounded-[28px] sm:rounded-[32px] border border-[rgba(26,28,24,0.06)] flex items-center justify-between gap-6 overflow-hidden relative shadow-xs flex-1">
                <div className="space-y-2 flex-1 max-w-[240px]">
                  {/* Recycle Icon */}
                  <div className="text-[#1a1c18] opacity-70">
                  ...
                  <h3 className="font-serif text-2xl sm:text-3xl text-[#1a1c18] font-normal leading-tight pt-1">
                    Eco-Friendly <br />
                    <span className="italic">Packaging</span>
                  </h3>
                  
                  <p className="text-xs text-[#1a1c18]/65 font-body leading-relaxed pt-1">
                    Eco-friendly materials designed to care for the planet as much as your skin.
                  </p>
                </div>

                <div className="w-28 sm:w-36 h-40 sm:h-48 shrink-0 flex items-center justify-center">
                  <img
              ...
              <div className="p-7 sm:p-8 bg-[#3c4433] text-white rounded-[28px] sm:rounded-[32px] border border-white/10 flex items-center justify-between gap-4 overflow-hidden relative shadow-xs flex-1">
                {/* Left Botanical Leaf Image */}
                <div className="w-28 sm:w-36 h-40 sm:h-48 shrink-0 flex items-end justify-start">
                  <img
                ...
                <div className="space-y-3 flex-1 pl-2">
                  ...
                  <div className="space-y-2 text-xs text-white/85 font-body">
                    <div className="flex items-center gap-2">
                      <Leaf className="w-3.5 h-3.5 text-[#dac5a7] shrink-0" />
                      <span>No Harsh Chemicals</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <Leaf className="w-3.5 h-3.5 text-[#dac5a7]" />
      ...
      {/* 7. EDITORIAL TESTIMONIAL & 3D PACKAGING COMPOSITION (Exact Reference Match) */}
      <section className="py-20 sm:py-28 bg-[#f2f2ef] text-center relative overflow-hidden">
        <div className="kanva-container max-w-4xl relative z-10">
          ...
          {/* Testimonial Quote in Sentient Serif */}
          <FramerReveal>
            <blockquote className="font-serif text-2xl sm:text-4xl lg:text-5xl text-[#1a1c18] font-normal leading-[1.3] tracking-[-0.02em] max-w-3xl mx-auto">
          ...
          <div className="mt-8 flex flex-col items-center">
            <h3 className="font-serif text-2xl sm:text-3xl text-[#1a1c18] font-normal">
              Jennifer K.
            </h3>
            <p className="font-mono text-xs text-[#1a1c18]/50 mt-1">
              Verified Buyer
            </p>
          </div>
          ...
          <div className="mt-12 sm:mt-16 relative flex items-center justify-center">
            <div className="relative w-full max-w-lg flex items-center justify-center py-6">
              ...
              <img
                ...
                className="w-full max-w-[340px] sm:max-w-[420px] lg:max-w-[460px] object-contain drop-shadow-[0_20px_40px_rgba(26,28,24,0.18)]"
              />

              {/* Floating Product Callout Card 1 (Top-Left attached to Tube) */}
              <div className="absolute left-0 sm:left-4 lg:-left-2 top-[24%] -translate-y-1/2 z-20">
                <div className="relative group cursor-pointer bg-white rounded-2xl p-2.5 sm:p-3 shadow-[0_12px_36px_rgba(26,28,24,0.12)] border border-[rgba(26,28,24,0.06)] flex items-center gap-3 transition-all hover:scale-105 hover:shadow-2xl">
                  {/* Product Thumbnail */}
                  ...
                  <div className="text-left pr-2">
                    <span className="text-[10px] font-mono uppercase tracking-wider text-[#1a1c18]/50 block">Lotions</span>
                    <h4 className="font-serif text-xs sm:text-sm font-medium text-[#1a1c18] leading-tight">Glow Milk</h4>
                    <span className="text-[11px] font-mono text-[#1a1c18]/70 block mt-0.5">8,95 €</span>
                  </div>
                </div>
              </div>
              ...
              <div className="absolute right-0 sm:right-4 lg:-right-2 top-[78%] -translate-y-1/2 z-20">
                <div className="relative group cursor-pointer bg-white rounded-2xl p-2.5 sm:p-3 shadow-[0_12px_36px_rgba(26,28,24,0.12)] border border-[rgba(26,28,24,0.06)] flex items-center gap-3 transition-all hover:scale-105 hover:shadow-2xl">
                  {/* Product Thumbnail */}
                  <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-[#f2f2ef] flex items-center justify-center p-1 shrink-0">
                    <img
                  ...
                  <div className="text-left pr-2">
                    <span className="text-[10px] font-mono uppercase tracking-wider text-[#1a1c18]/50 block">Lotions</span>
                    <h4 className="font-serif text-xs sm:text-sm font-medium text-[#1a1c18] leading-tight">Daily Flow</h4>
                    <span className="text-[11px] font-mono text-[#1a1c18]/70 block mt-0.5">7,95 €</span>
                  </div>
                </div>
              </div>
      ...
      <section className="py-12 sm:py-16">
        <div className="kanva-container">
          <div className="relative bg-[#3c4433] text-white rounded-3xl sm:rounded-[36px] overflow-hidden p-8 sm:p-14 lg:p-16 border border-white/10 shadow-2xl min-h-[420px] sm:min-h-[460px] flex items-center">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center w-full relative z-10">
              ...
              <div className="lg:col-span-7 space-y-6">
                <h2 className="font-serif text-4xl sm:text-5xl lg:text-[56px] text-white font-normal leading-[1.08] tracking-[-0.03em]">
                  <span className="text-white block">Stay Updated,</span>
                  <span className="italic text-white/70 block">Stay Radiant</span>
                </h2>

                <p className="text-sm sm:text-base text-white/75 font-body leading-relaxed max-w-sm">
                  Be the first to know about new products, offers, and skincare tips.
                </p>

                {isSubscribed ? (
                  <div className="p-4 bg-white/10 rounded-full text-xs font-mono text-[#dac5a7] flex items-center gap-2 max-w-sm">
                    <Check className="w-4 h-4 text-[#dac5a7]" />
                    <span>You are subscribed! Welcome dispatches will arrive in your inbox.</span>
                  </div>
                ) : (
                  <form onSubmit={handleNewsletterSubmit} className="relative flex items-center bg-white rounded-full p-1.5 max-w-sm shadow-md">
                    <input
                      type="email"
                      value={newsletterEmail}
                      onChange={(e) => setNewsletterEmail(e.target.value)}
                      placeholder="Your Email"
                      className="flex-1 pl-4 pr-2 py-2 text-xs sm:text-sm text-[#1a1c18] placeholder-[#1a1c18]/50 bg-transparent focus:outline-none font-sans"
                    />
                    <button
                      type="submit"
                      className="px-6 py-2.5 bg-[#757d5c] hover:bg-[#5f664a] text-white rounded-full text-xs font-semibold tracking-wide transition-colors cursor-pointer shrink-0 shadow-sm"
                    >
                      Subscribe
                    </button>
                  </form>
              ...
              <div className="lg:col-span-5 relative h-72 sm:h-80 lg:h-96 w-full flex items-center justify-center overflow-visible">
                {/* Background Leaf Right (Rotated 22deg) */}
                <img
                  src="/assets/images/51e9kGMQvtvIcZEQUda1STNUks.webp"
                  alt="Botanical Leaf"
                  className="absolute right-0 sm:right-6 lg:right-8 top-1/2 -translate-y-[45%] w-48 sm:w-60 lg:w-72 object-contain rotate-[22deg] pointer-events-none drop-shadow-2xl opacity-95"
                />
                {/* Background Leaf Left (Rotated -29deg) */}
                <img
                  src="/assets/images/r5OUYIwpZUeIh5LNk3XDju6XzU.webp"
                  alt="Botanical Leaf"
                  className="absolute left-2 sm:left-8 lg:left-10 top-1/2 -translate-y-[40%] w-44 sm:w-56 lg:w-64 object-contain -rotate-[29deg] pointer-events-none drop-shadow-xl opacity-95"
                />
                {/* Front Center Amber Glass Pump Bottle */}
                <img
                  src="/assets/images/kgUNYolMVd4DrZKxkAYYHJgc.webp"
                  alt="Amber Glass Pump Bottle"
                  className="relative z-10 w-28 sm:w-36 lg:w-44 object-contain drop-shadow-[0_25px_35px_rgba(0,0,0,0.5)] transform -translate-y-2"
                />
              </div>
      ...
      <section className="py-16">
        <div className="kanva-container">
          <div className="text-center mb-8">
            ...
            <p className="text-xs font-mono text-[#1a1c18]/50 mt-1 uppercase tracking-widest">
              @kanva.skincare • Editorial Botanical Apothecary
            </p>
          </div>
