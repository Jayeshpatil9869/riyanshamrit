            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full pl-10 pr-11 py-2.5 bg-[#f8f8f5] focus:bg-white border border-[rgba(26,28,24,0.12)] focus:border-[#3c4433] rounded-xl text-xs text-[#1a1c18] focus:outline-none transition-all"
                />
                <button
                  type="button"
